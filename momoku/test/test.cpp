...
void PrintTest() {
	...
	testText += "TT cutoff: " + std::to_string(testData[TTcutoff]) + "\n";
	testData[TTcutoff] = 0;
	testText += "beta cutoff: " + std::to_string(testData[betacutoff]) + "\n";
	testData[betacutoff] = 0;
	testText += "vcf TT cutoff: " + std::to_string(testData[vcfTTcutoff]) + "\n";
	testData[vcfTTcutoff] = 0;
	testText += "vcf beta cutoff: " + std::to_string(testData[vcfbetacutoff]) + "\n";
	testData[vcfbetacutoff] = 0;
	testText += "moveCnt pruning: " + std::to_string(testData[moveCntpruning]) + "\n";
	testData[moveCntpruning] = 0;
	testText += "dispersed T: " + std::to_string(testData[dispersedT]) + "\n";
	testData[dispersedT] = 0;
	testText += "TDH3 T4H3 win check: " + std::to_string(testData[TDH3T4H3wincheck]) + "\n";
